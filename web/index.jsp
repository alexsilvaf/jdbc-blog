...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
                    ...
                    <div class="col-md-3 text-end">
                        ...
                        <a href="Cliente/pages/inserir.html" class="btn btn-primary">Sign-up</a>
                    </div>
                </header>
            </div>
        </div>
        <main class="form-signin w-25 m-auto">
            ...
            <form action="Cliente/actions/logar.jsp?usuario=<%=cliente.getUsuario()%>&senha=<%=cliente.getSenha()%>" method="GET">
